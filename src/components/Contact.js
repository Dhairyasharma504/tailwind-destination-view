      ...
      <div className="container px-4 py-10 mx-auto max-w-screen-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="">
            ...
            <Description text="Ask us everything and we would love to hear from you"></Description>
            ...
            <form className="mt-12">
              ...
              <button className="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-md focus:outline-none">
                get in touch
              </button>
            </form>
          </div>

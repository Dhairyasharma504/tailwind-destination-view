  ...
  return (
    <div className="w-full h-[90vh] bg-images top-0 left-0 bg-cover  ">
      <div className="bg-black/25 h-[90vh]">
        <div className=" p-6  h-full flex flex-col justify-center  w-full text-lightshade ">
          ...
          <div class="   ">
            <p class="text-xl sm:text-2xl xl:text-5xl text-center md:text-left  font-extrabold  leading-6 xl:leading-10 text-lightshade pb-6">
              Let&apos;s Enjoy The Wonders of Nature
            </p>
            <p class="mt-4  text-center md:text-left text-xl leading-normal text-lightshade">

...
//             <span className="text-xs uppercase text-brand tracking-widest">
//               {' '}
//               Call{' '}
//             </span>
...
//           <ul className="mt-8 space-y-2 text-sm text-lightshade">
...
//             <Link
//               className="rounded-full border border-brand  text-brand /25 p-2 hover:opacity-75"
//               href=""
//               target="_blank"
//               rel="noreferrer"
//             >
...
//             <Link
//               className="rounded-full border b border-brand  text-brand /25 p-2 hover:opacity-75"
//               href=""
//               target="_blank"
//               rel="noreferrer"
//             >
...
//       <div className="mt-12 border-t botext-lightshade pt-12 flex justify-center">
...
//               &copy; 2022 The Chin Inn - All Rights Reserved. Made with
//               <AiOutlineHeart />
//               by Zeiq
//             </p>{' '}
//           </div>
  ...
  return (
    <div>
      <footer
        ...
        className=" bg-darkshade lg:grid lg:grid-cols-5"
      >
        <div className="relative block h-32 lg:col-span-2 lg:h-full">
          <Image
            src="/images/gallery-1.jpg.webp"
        ...
        <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
            <div>
              <p>
                <span className="text-xs tracking-wide text-lightshade uppercase">
                  Call us
                </span>
              ...
              <ul className="mt-8 space-y-1 text-sm text-lightshade">
                <li>Monday to Friday: 10am - 5pm</li>
                <li>Weekend: 10am - 3pm</li>
              </ul>
          ...
          <div className="pt-12 mt-12 border-t botext-lightshade">

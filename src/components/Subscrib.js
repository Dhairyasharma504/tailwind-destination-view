    ...
    <div>
      <div class="xl:flex items-center 2xl:mx-auto 2xl:container py-16 sm:mx-20">
        <div class="lg:p-24 sm:p-9 md:p-16 p-4 2xl:w-8/12 xl:w-11/12 w-full sm:border-2 sm:border-gray-800">
          ...
          <p class="text-base leading-4 mt-2 text-gray-600 dark:text-white">
          ...
          <div class="sm:flex items-center mt-10 xl:pb-0 pb-32">
            ...
            <button class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 hover:bg-black text-base font-medium leading-none text-white py-4 px-6 bg-gray-800 sm:ml-2 sm:w-auto w-full sm:mt-0 mt-4 dark:bg-white dark:text-gray-900 dark:hover:bg-gray-100">
              Subscribe
            </button>
          </div>
        </div>
